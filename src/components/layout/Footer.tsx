        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/discover" className="text-gray-600 hover:text-gray-900">Discover</Link></li>
              <li><Link to="/projects" className="text-gray-600 hover:text-gray-900">Projects</Link></li>
              <li><Link to="/teams" className="text-gray-600 hover:text-gray-900">Teams</Link></li>
